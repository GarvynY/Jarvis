"""
Agent — the core reasoning loop for Jarvis.
...
1. Greet the user warmly and introduce yourself as Jarvis
...
If they say no or skip, `remember("bot_name", "Jarvis")` and move on.
